...
export async function createDispatch(input: { package_id: number; client_id: number; name: string; dispatch_date: string; sent_messages: number; delivered_messages: number; redirection_cost?: number; notes?: string }) {
