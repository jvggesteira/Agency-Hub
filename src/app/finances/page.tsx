...
import { DollarSign, TrendingUp, TrendingDown, Plus, Search, Filter, Edit, Trash2, Calendar } from 'lucide-react';
import { z } from 'zod';
        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <h3 className="text-sm font-medium text-slate-600 mb-1">Receitas</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <h3 className="text-sm font-medium text-slate-600 mb-1">Despesas</h3>
              <p className="text-2xl font-bold text-slate-900">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <h3 className="text-sm font-medium text-slate-600 mb-1">Saldo</h3>
