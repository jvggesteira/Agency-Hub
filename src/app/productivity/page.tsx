            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <Card className="shadow-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-slate-900 dark:text-white">{metrics.totalTasks}</div>
                    <p className="text-xs text-slate-500 dark:text-slate-400">{metrics.pending} pendentes, {metrics.statusDistribution['em_andamento'] || 0} em andamento</p>
                  </CardContent>
                </Card>
                ...
                <Card className="shadow-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-green-600 dark:text-green-400">{metrics.concluded}</div>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Taxa de conclusão: {metrics.completionRate.toFixed(1)}%</p>
                  </CardContent>
                </Card>
                ...
                <Card className="shadow-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">Requer atenção imediata</p>
                  </CardContent>
                </Card>
                ...
                <Card className="shadow-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-slate-900 dark:text-white">{metrics.averageTime.toFixed(1)}</div>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Dias para conclusão</p>
                  </CardContent>
                </Card>
              </div>
                    ...
                    <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-800">
                      ...
                      <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                        {ranking.map((stat, index) => (
                          <tr key={stat.name} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                            <td className="py-3 px-4 text-sm font-semibold text-slate-900 dark:text-white">#{index + 1}</td>
                            <td className="py-3 px-4 text-sm text-slate-700 dark:text-slate-200">{stat.name}</td>
                            <td className="py-3 px-4 text-sm text-slate-700 dark:text-slate-200">{stat.total}</td>
                            <td className="py-3 px-4 text-sm text-green-600 dark:text-green-400">{stat.concluded}</td>
                            <td className="py-3 px-4 text-sm">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-slate-700 dark:text-slate-200">{stat.completionRate.toFixed(0)}%</span>
                              </div>
                            </td>
                            <td className="py-3 px-4 text-sm text-red-600 dark:text-red-400">{stat.overdue}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
